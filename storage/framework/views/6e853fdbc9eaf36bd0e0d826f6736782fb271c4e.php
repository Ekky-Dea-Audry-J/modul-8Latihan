...
<div class="col-md-12 mb-3">
    ...
    <option value="<?php echo e($position->id); ?>" <?php echo e(old('position') ==
    $position->id ? 'selected' : ''); ?>><?php echo e($position->code.' -
...
<div class="col-md-6 d-grid">
    <a href="<?php echo e(route('employees.index')); ?>"class="btn btn-outline-dark btn-lg mt-3"><i class="bi-arrow-left-circle
me-2"></i> Cancel</a>
</div>
...
<?php /**PATH C:\Users\EKKY DEA\modul4Ekky\resources\views/employee/create.blade.php ENDPATH**/ ?>