...
id="navbarSupportedContent">
    ...
    <hr class="d-lg-none text-white-50">
    <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light my-2 ms-md-auto"><i class="bi-person-circle me-1"></i>
Profile</a>
        </div>
    </div>
</nav>
...
<?php /**PATH C:\Users\EKKY DEA\modul4Ekky\resources\views/profile.blade.php ENDPATH**/ ?>