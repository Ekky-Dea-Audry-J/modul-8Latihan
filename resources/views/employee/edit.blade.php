...
@error('kodebarang') is-invalid @enderror" type="text"
                                ...
                                value="{{ $errors->any() ? old('kodebarang') : $employee->kodebarang }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('nama barang')
is-invalid @enderror" type="text"
                                name="namabarang" id="namabarang"
                                value="{{ $errors->any() ? old('namabarang') : $employee->namabarang }}"
...
is-invalid @enderror" type="text"
                                ...
                                value="{{ $errors->any() ? old('hargabarang') : $employee->hargabarang }}"
...
is-invalid @enderror" type="text" name="deskripsibarang"
                                id="deskripsibarang" value="{{ $errors->any() ? old('deskripsibarang') : $employee->deskripsibarang }}"
